...
class RailGoApi {
  ...
  Future<Response<Map<String, dynamic>>> trainQueryV1(String train) =>
      _client.get<Map<String, dynamic>>(ServiceCode.train, '/api/train/query',
          query: {'train': train});
  ...
  Future<Response<Map<String, dynamic>>> getTrainMain(
          {required String trainNum, String? date}) =>
      _client.get<Map<String, dynamic>>(
          ServiceCode.trainV2, '/api/v2/getTrainMain', query: {
        'trainNum': trainNum,
  ...
  Future<Response<Map<String, dynamic>>> getExit({
    ...
    required bool isDepartureStop,
      ...
      _client.get<Map<String, dynamic>>(ServiceCode.exit, '/api/v2/getExit',
          query: {
            'trainNum': trainNum,
  ...
  Future<Response<Map<String, dynamic>>> getStationBigScreen({
    ...
    required String kind,
      ...
      _client.get<Map<String, dynamic>>(
          ServiceCode.bigScreen, '/api/v2/getStationBigScreen',
          query: {'stationTelecode': stationTelecode, 'kind': kind});

  /// V2 列车车厢图：/api/v2/getCoachPic?train=
  Future<Response<Map<String, dynamic>>> getCoachPic(String train) => _client
      .get<Map<String, dynamic>>(ServiceCode.coach, '/api/v2/getCoachPic',
          query: {'train': train});

  /// V2 列车运行线路点：/api/v2/mapLine?train=（GCJ-02 坐标，需转 WGS-84）
  Future<Response<Map<String, dynamic>>> getMapLine(String train) =>
      _client.get<Map<String, dynamic>>(ServiceCode.mapLine, '/api/v2/mapLine',
          query: {'train': train});
  ...
  Future<Response<Map<String, dynamic>>> emuRun(String keyword) =>
      _client.get<Map<String, dynamic>>(ServiceCode.emuRun, '/api/query',
          query: {'keyword': keyword});

  /// EMU 配属预查询：/api/car/query?keyword=&keywordType=Number|Model
  Future<Response<Map<String, dynamic>>> emuAssignmentPre(String keyword,
          {required String keywordType}) =>
      _client.get<Map<String, dynamic>>(
          ServiceCode.emuAssignment, '/api/car/query',
          query: {'keyword': keyword, 'keywordType': keywordType});

  /// EMU 配属详情：/api/car/info?id=
  Future<Response<Map<String, dynamic>>> emuAssignmentInfo(String id) => _client
      .get<Map<String, dynamic>>(ServiceCode.emuAssignment, '/api/car/info',
          query: {'id': id});
  ...
  Future<Map<String, List<ServiceEndpoint>>> discoverServiceEndpoints() async {
    final resp = await _client.get<List<dynamic>>(
        ServiceCode.notice, '/api/v2/service_endpoints');
  ...
  Future<Response<Map<String, dynamic>>> androidPackUrl() =>
      _client.get<Map<String, dynamic>>(
          ServiceCode.updatePack, '/api/v2/url/pack/android');
  ...
  Future<Response<List<dynamic>>> feedbackUsers() => _client
      .getAbsolute<List<dynamic>>('https://feedback.railgo.dev/api/get_users');
  ...
  Future<Response<Map<String, dynamic>>> trainAssignmentQueryEmu(
  ...
  Future<Response<Map<String, dynamic>>> galleryModelSearch(
          Map<String, dynamic> query) =>
      _client.getAbsolute<Map<String, dynamic>>(
          'https://train.idcmoss.cn/api/model_search.php',
          query: query);

  /// 车模图库照片：train.idcmoss.cn/api/model_photos.php
  Future<Response<Map<String, dynamic>>> galleryModelPhotos(
          Map<String, dynamic> query) =>
      _client.getAbsolute<Map<String, dynamic>>(
          'https://train.idcmoss.cn/api/model_photos.php',
          query: query);
